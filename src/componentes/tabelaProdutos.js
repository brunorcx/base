...
const headCells = [
  ...
  { id: "calories", numeric: true, disablePadding: true, label: "Nome" },
  { id: "fat", numeric: true, disablePadding: false, label: "Preço" },
  { id: "carbs", numeric: true, disablePadding: false, label: "Quantidade" },
  { id: "protein", numeric: true, disablePadding: true, label: "Categorias" },
];
